    ...
    opts = function()
        ...
        return {
                ...
                fallthrough = false,
                {
                    condition = function(self)
                        return vim.opt.diff:get() or
                            status.condition
                            .buffer_matches(self.disabled or {})
                    end,
                    init = function()
            ...
            tabline = { -- bufferline
                ...
                status.heirline.make_buflist(status.component
                .tabline_file_info()), -- component for each buffer tab
                ...
                { -- tab list
                    ...
                    { -- close button for current tab
                        ...
                        on_click = {
                            callback = function()
                                require("core.utils.buffer").close_tab()
                            end,
